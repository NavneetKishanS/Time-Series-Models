...
#
# Output:
#   /dbfs/FileStore/spark_pipeline/models/exchange/exchange_model_best.pt
#   /dbfs/FileStore/spark_pipeline/models/examination/examination_model_best.pt
#   /dbfs/FileStore/spark_pipeline/models/orchestration/orchestration_model_best.pt
...
PKL_PATH   = "/dbfs/FileStore/spark_pipeline/preprocessed_data.pkl"
MODELS_DIR = "/dbfs/FileStore/spark_pipeline/models"
...
# =============================================================================
import sys, time
_LOG_DIR  = "/dbfs/FileStore/spark_pipeline/logs"
...
try:
    ...
    _URL = f"https://{_WS}/files/spark_pipeline/logs/{_LOG_NAME}"
...
_artifacts = {
    "run log":         (_LOG_PATH,      f"spark_pipeline/logs/{_LOG_NAME}"),
    "model manifest":  (_manifest_path, "spark_pipeline/models/MODEL_MANIFEST.json"),
    "duration probe":  (_PROBE_PATH,    "spark_pipeline/models/examination/duration_probe.json"),
}
try:
    _WS = spark.conf.get("spark.databricks.workspaceUrl")
    _links = "".join(
...
# COMMAND ----------
  ...
  ckpt_dir = "/dbfs/FileStore/spark_pipeline/models/exchange"                                                                                                                
...
# COMMAND ----------
  ...
  import os, time                                                                                                                                                          
  d = "/dbfs/FileStore/spark_pipeline/models/examination"
