...
import time, json, hashlib, gc, ctypes

# Aggressively free accumulated memory before the large pickle load (~5.5 GiB
# deserialized). On this 28 GiB node the margin is thin after JVM + CUDA context.
gc.collect()
try:
